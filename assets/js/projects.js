const PROJECTS = [
{ id:'fidal', category:'audiovisuel', cover:'assets/img/fidal.svg', title:'Fidal — Vidéo promotionnelle', year:2025, summary:"Réalisation d’une vidéo de promotion pour Fidal afin de valoriser le cabinet et son attractivité, notamment auprès des jeunes diplômés.", videoId:'uwGRvy0acEU', stack:['Premiere Pro','After Effects', 'Adobe Audition'], role:'Son, pitch du projet et motion design', context:'Projet Scolaire', links:{ video:'https://youtu.be/uwGRvy0acEU' } },
...
{ id:'mmihub', category:'web', title:'MMI Hub', year:2025, summary:"Plateforme web pensée pour les étudiants : suivi de scolarité (notes, absences, infos) avec une expérience proche de Pronote, adaptée à l’enseignement supérieur.", cover:'assets/img/mmihub.svg', stack:['HTML', 'CSS', 'JS', 'PHP', 'SQL', 'Hugo'], context:'Projet Personnel', pitch:'', links:{ repo:'https://jawisjan.tpweb.univ-rouen.fr/mmihub' } },
{ id:'etukit', category:'web', title:'EtuKit', year:2023, summary:"Boîte à outils complète pour étudiants : aides disponibles, tips, ressources et conseils pour gagner du temps et mieux s’organiser pendant l’année.", cover:'assets/img/etukit_logo.svg', stack:['React','Tailwind','MySQL','APIs France Travail & Gemini', 'HTML', 'JavaScript', 'CSS'], context:'Projet Personnel', pitch:'', links:{ repo:'https://etukit.fr/' } },
{ id:'sae303',  pdf:'assets/pdfs/meteo.pdf',    category:'web', title:'Dashboard Météo', year:2025, summary:'Dans un cadre de SAE j\'ai du créer une représentation de données présents dans une bdd concernant les relevés météorologiques pour le département du 31 et les réprésenter dans des graphes et justifier leur utilisation.', cover:'assets/img/sae301.svg', stack:['HTML', 'CSS', 'JS', 'php', 'sql'], context:'Projet Personnel', pitch:'', links:{ repo:'https://jawisjan.tpweb.univ-rouen.fr/station_meteo/' } },
...
{ id:'cc', category:'web', title:'Chourak Consulting', year:2025, summary:"Création d’un site web pour Chourak Consulting avec une identité visuelle et une mise en page sur mesure, orientées clarté et conversion.", cover:'assets/img/chourak.svg', stack:['HTML','CSS','JS'], context:'Projet Personnel', links:{ demo:'https://chourak-consulting.fr/' } },
{ id:'abl', category:'web', title:'ABL', year:2025, summary:"Création d’un site vitrine pour présenter les services d’ABL : structure claire, pages essentielles, optimisation SEO de base et déploiement.", cover:'assets/img/abl.svg', stack:['HTML', 'CSS', 'JS'], context:'Projet Personnel', pitch:'', links:{ repo:'https://ablfrance.fr/' } },
{ id:'oopticien', category:'web', title:'Oopticien', year:2025, summary:"Création d’un site vitrine pour Oopticien : design, mise en page, SEO local et mise en ligne après échanges sur l’identité et les besoins.", cover:'assets/img/logo_oopticien.svg', stack:['HTML','CSS/Bootstrap','JavaScript','SEO local', 'Hébergement', 'Photographie'], context:'Projet Personnel', links:{ demo:'https://oopticien.fr' } },
{ id:'sae203', category:'web', title:'Site de billeterie', year:2024, summary:'Dans le cadre de mes études je devais faire un site de billeterie en ligne avec la possibilité de la création d\'un compte et de la gestion de rôle.', cover:'assets/img/sae203.svg', stack:['HTML','CSS','JavaScript','PHP', 'SQL'], context:'Projet Scolaire', pitch:'', links:{ repo:'https://jawisjan.tpweb.univ-rouen.fr/sae203' } },
  ...
  { id:'ppp', category:'audiovisuel', cover:'assets/img/freelance.svg', title:'Comment se lancer en Freelance ?', year:2024, summary:'Le but était de faire une vidéo pour expliquer à nos camarades comment se lancer en freelance. Evidemment nous avions des contraintes, comme la durée, on a abordé le reste des points à l\'oral pendant notre passage.', videoId:'Q6F7pyI0tCw', stack:['After Effects', 'Premiere Pro', 'Adobe Audition'], role:'Motion design, montage et voix', context:'Projet Personnel', links:{ video:'https://youtube.com/shorts/Q6F7pyI0tCw' } },


{
  id:'cvec',
  category:'comm',
  title:'Projet CVEC — Salle étudiante',
  year:2025,
  summary:"Proposition CVEC pour améliorer la vie sur le campus : créer une salle étudiante (jeux, détente, espace social) accessible et conviviale.",
